...
//        }
        ...
        veiculos0.add(new Carro());
        veiculos0.add(new Bicicleta());
...
//            System.out.println();
//        }
//        System.out.println("--- Teste para vei­culos iniciando em 80 --- ");
...
//        contas.add(new ContaCorrente("João",1000));
//        contas.add(new ContaPoupanca("Maria",500));
